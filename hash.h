...
/* 获取哈希表的桶下标 */
#define hash_min(key, bits)                                             \
    ( sizeof((key)) <= 4 ? hash_32(key, bits) : hash_64(key, bits) )
...
static inline int __ilog2_u32(unsigned int u) { return fls(u) - 1; }
static inline int __ilog2_u64(unsigned long u) { return fls64(u) - 1;  }
